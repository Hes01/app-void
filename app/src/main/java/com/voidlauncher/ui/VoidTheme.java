...
final class VoidTheme {
    ...
    static int FG3     = 0x7AEDEDED;
    static int FG4     = 0x4DEDEDED;
    static int FG5     = 0x2EEDEDED;
    ...
    static void apply(int mode) {
        ...
        if (isDay) {
            ...
            FG3     = 0x7A111111; FG4     = 0x4D111111;
            FG5     = 0x2E111111; LINE    = 0x14000000;
            ACCENT  = 0xFF111111;
            ...
            FG3     = 0x7AEDEDED; FG4     = 0x4DEDEDED;
            FG5     = 0x2EEDEDED; LINE    = 0x14FFFFFF;
            ACCENT  = 0xFFEDEDED;
